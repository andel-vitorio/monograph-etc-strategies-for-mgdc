...
\usepackage{subfig}     % Possibilita a inserção de subfiguras
...
\newacronym{red}{RED}{Recurso Energético Distribuído}
...
\newacronym[\glslongpluralkey={sistenas de armazenamento de energia}]{sae}{SAE}{sistema de armazenamento de energia}

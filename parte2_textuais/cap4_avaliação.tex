...
\begin{table}[H]
  ...
  \begin{minipage}{.5\textwidth}
    ...
    \begin{tabular}{ccc}
      \toprule
      \multirow{2}{*}{\centering Cenário} & \multicolumn{2}{c}{\centering Modelo}                \\
      \cmidrule{2-3}
                                          & Não linear                            & Linearizado  \\
      \midrule
      1                                   & 0,278 ms                              & 0,261 ms     \\
      2                                   & 0,583 $\mu$s                          & 0,581 $\mu$s \\
      3                                   & 0,600 ms                              & 0,600 ms     \\
      4                                   & 0,024 $\mu$s                          & 0,022 $\mu$s \\
      \bottomrule
    \end{tabular}
    \captionsetup{justification=centering}

    \caption{Médias dos \acrshortpl{imee} sob \newline \acrshort{etm} estático.}
    \label{table:mean_imee_static_etm}
  \end{minipage}%
  \begin{minipage}{.5\textwidth}
    \centering
    \setlength{\tabcolsep}{10pt}
    ...
    \caption{Médias dos \acrshortpl{imee} sob \newline \acrshort{etm} dinâmico.}
    \label{table:mean_imee_dynamic_etm}
  \end{minipage}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{ccccccc}
    ...
    \midrule
    1 & Não linear & 99,99 ms & 3,98 & 0,04 & 0,04\\  
    1 & Linearizado & 99,99 ms & 2,57 & 0,02 & 0,04 \\  
    2 & Não linear & 3,35 ms & 0,02 & 21,70 $\cdot 10^{-6}$ & 0,04 \\  
    2 & Linearizado & 3,30 ms & 0,02 & 20,40 $\cdot 10^{-6}$ & 0,04 \\
    \bottomrule
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ccccccc}
    ...
    Cenário & Modelo & Tempo de acomodação & \acrshort{ise} & \acrshort{itse} & \acrshort{isc} \\
    \midrule
    1 & Não linear & 100,00 ms & 3,98 & 0,04 & 0,04\\  
    1 & Linearizado & 100,00 ms & 2,57 & 0,02 & 0,04 \\  
    2 & Não linear & 3,35 ms & 0,02 & 21,70 $\cdot 10^{-6}$ & 0,04 \\  
    2 & Linearizado & 3,30 ms & 0,02 & 20,40 $\cdot 10^{-6}$ & 0,04 \\
    \bottomrule
  \end{tabular}
...
\subsubsection{Variação do Parâmetro $\mu$ }
...
\begin{table}[H]
  ...
  \begin{minipage}{.5\textwidth}
    ...
    \begin{tabular}{ccc}
      ...
      \midrule
      1                                   & 0,147 s                               & 0,148 s      \\
      2                                   & 10,01 $\mu$s                          & 8,897 $\mu$s \\
      3                                   & 0,142 s                               & 0,077 s      \\
      4                                   & 21,62 $\mu$s                          & 21,65 $\mu$s \\
      \bottomrule
    \end{tabular}
    \captionsetup{justification=centering}

    \caption{Médias dos \acrshortpl{imee} sob \newline \acrshort{etm} estático.}
    \label{table:mean_imee_static_etm_boost}
  \end{minipage}%
  \begin{minipage}{.5\textwidth}
    \centering
    \setlength{\tabcolsep}{10pt}
    \begin{tabular}{ccc}
      ...
      \midrule
      1                                   & 0,091 s                               & 0,148 s      \\
      2                                   & 83,47 $\mu$s                          & 91,45 $\mu$s \\
      3                                   & 0,159 s                               & 0,128 s      \\
      4                                   & 33,07 $\mu$s                          & 34,21 $\mu$s \\
      \bottomrule
    \end{tabular}
    \captionsetup{justification=centering}

    \caption{Médias dos \acrshortpl{imee} sob \newline \acrshort{etm} dinâmico.}
    \label{table:mean_imee_dynamic_etm_boost}
  \end{minipage}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{ccccccc}
    ...
    Cenário & Modelo & Tempo de acomodação & \acrshort{ise} & \acrshort{itse} & \acrshort{isc} \\
    \midrule
    5 & Não linear & 0,75 s & 201 & 21,30 & 0,08\\  
    5 & Linearizado & 0,75 s & 124 & 10,60 & 0,08 \\  
    6 & Não linear & 0,11 ms & 0,08 & 96,80 $\cdot 10^{-6}$ & 0,01 \\  
    6 & Linearizado & 0,11 ms & 0,08 & 120,00 $\cdot 10^{-6}$ & 0,01 \\
    \bottomrule
  \end{tabular}
  \caption{Pontos de operação do dois modelos do conversor Buck. Estático}
  \label{table:op_parameters_boost}
